...
from .views import (
    ...
    DashboardReviewStatusUpdateView,
...
urlpatterns = [
    ...
    path('reviews/', DashboardReviewListView.as_view(), name='review_list'),
    path('reviews/<int:review_id>/status/', DashboardReviewStatusUpdateView.as_view(), name='review_status_update'),
