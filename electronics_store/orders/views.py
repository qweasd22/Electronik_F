...
def checkout(request):
    ...
    delivery_cost = Decimal("200.00") if delivery_method == "standard" else Decimal("500.00")
    ...
    if request.headers.get("X-Requested-With") == "XMLHttpRequest":
        return JsonResponse({
            "total_price_without_discount": str(total_price_without_discount),
            "total_price_with_discount": str(total_price_with_discount),
